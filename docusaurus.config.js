...
const prismLightCodeTheme = require("prism-react-renderer/themes/github");
const prismDarkCodeTheme = require("prism-react-renderer/themes/dracula");
  ...
  return {
    ...
    themeConfig:
      ...
      ({
        ...
        prism: {
          theme: prismLightCodeTheme,
          darkTheme: prismDarkCodeTheme,
